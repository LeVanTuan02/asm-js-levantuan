                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-3">
                                        ...
                                        <div class="mt-1">
                                            <img src="https://res.cloudinary.com/levantuan/image/upload/v1644302455/assignment-js/thumbnail-image-vector-graphic-vector-id1147544807_ochvyr.jpg" alt="Preview Img" id="form__add-slider-preview" class="h-60 w-full object-cover rounded-md">
                                        </div>
                                    </div>
